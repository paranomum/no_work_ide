...
import ru.rt.iqhr.services.invoker.RFC3339DateFormat;
import ru.rt.iqhr.services.invoker.auth.Authentication;
import ru.rt.iqhr.services.invoker.auth.HttpBasicAuth;
import ru.rt.iqhr.services.invoker.auth.HttpBearerAuth;
...
public class ApiClient extends JavaTimeFormatter {
    ...
    private String basePath = "https://iqhr-referral-service.apps.okd.stage.digital.rt.ru/referral";
    ...
    protected void init() {
        ...
        // имя "bearerAuth" должно совпадать с securitySchemes в OpenAPI
        auths.put("bearer-jwt", new HttpBearerAuth("bearer"));

        authentications = Collections.unmodifiableMap(auths);
    }
